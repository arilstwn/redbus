...
<body>
    ...
    <div class="container-fluid">
        <div class="mb-3">
            <h3>Tambah Kelas Bus</h3>
            
            <div class="container">
<div class="forms">
<div class="form login">
    <span class="title">Tambah Kelas</span>

  <!-- ... (previous HTML code) ... -->

<form action="<?php echo base_url('admin/aksi_tambah_kelas') ?>" method="post">
<div class="input-field">
<input type="text" id="kelas" name="kelas" placeholder="Nama kelas" required>
<i class="uil uil-edit-alt"></i>
</div>

<div class="input-field">
<input type="text" id="jumlah_kursi" name="jumlah_kursi" placeholder="Jumlah kursi Bus" required>
<i class="uil uil-edit-alt"></i>
</div>
