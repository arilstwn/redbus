                ...
                <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="whitespace-nowrap px-4 py-2 text-center text-gray-700">
                                                        <?php echo $waifu->nama_tiket ?>
                                                    </td>
                                                    <td class="whitespace-nowrap px-4 py-2 text-center text-gray-700">
                                                        <?php echo $waifu->kelas ?>
                                                    </td>   
                                                    <td class="whitespace-nowrap px-4 py-2 text-center text-gray-700">
                                                        <?php echo $waifu->tujuan ?>
                                                    </td>   
                                                    <td class="whitespace-nowrap px-4 py-2 text-center text-gray-700">
                                                        <?php echo $waifu->harga ?>
                                                    </td>   
                                                    <td data-cell="Aksi" class="justify-content-center px-3 py-4 flex">
                                                    <a href="ubah_tiket" style="border-radius: 8px;margin-top: 10%;" class="a a1">Ubah</a>
